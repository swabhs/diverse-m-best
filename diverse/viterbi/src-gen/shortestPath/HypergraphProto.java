...
// source: basicViterbi/hypergraph.proto
...
public final class HypergraphProto {
  ...
  public static final class Vertex extends
    ...
    public static final class Builder extends
       ...
       implements shortestPath.HypergraphProto.VertexOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return shortestPath.HypergraphProto.internal_static_shortestPath_Vertex_descriptor;
      }
      ...
      public shortestPath.HypergraphProto.Vertex build() {
        shortestPath.HypergraphProto.Vertex result = buildPartial();
      ...
      public shortestPath.HypergraphProto.Vertex buildPartial() {
        shortestPath.HypergraphProto.Vertex result = new shortestPath.HypergraphProto.Vertex(this);
  ...
  public static final class Hyperedge extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements shortestPath.HypergraphProto.HyperedgeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return shortestPath.HypergraphProto.internal_static_shortestPath_Hyperedge_descriptor;
      }
      ...
      public shortestPath.HypergraphProto.Hyperedge build() {
        shortestPath.HypergraphProto.Hyperedge result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public shortestPath.HypergraphProto.Hyperedge buildPartial() {
        shortestPath.HypergraphProto.Hyperedge result = new shortestPath.HypergraphProto.Hyperedge(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
  ...
  public interface HypergraphOrBuilder
    ...
    java.util.List<shortestPath.HypergraphProto.Vertex> 
        getVerticesList();
    shortestPath.HypergraphProto.Vertex getVertices(int index);
    int getVerticesCount();
    java.util.List<? extends shortestPath.HypergraphProto.VertexOrBuilder> 
        getVerticesOrBuilderList();
    shortestPath.HypergraphProto.VertexOrBuilder getVerticesOrBuilder(
        int index);
    
    // repeated .shortestPath.Hyperedge edges = 2;
    java.util.List<shortestPath.HypergraphProto.Hyperedge> 
        getEdgesList();
    shortestPath.HypergraphProto.Hyperedge getEdges(int index);
    int getEdgesCount();
    java.util.List<? extends shortestPath.HypergraphProto.HyperedgeOrBuilder> 
        getEdgesOrBuilderList();
    shortestPath.HypergraphProto.HyperedgeOrBuilder getEdgesOrBuilder(
        int index);
  }
  public static final class Hypergraph extends
    ...
    public java.util.List<? extends shortestPath.HypergraphProto.VertexOrBuilder> 
        getVerticesOrBuilderList() {
      return vertices_;
    }
    ...
    public shortestPath.HypergraphProto.VertexOrBuilder getVerticesOrBuilder(
        int index) {
      return vertices_.get(index);
    }
    ...
    public java.util.List<? extends shortestPath.HypergraphProto.HyperedgeOrBuilder> 
        getEdgesOrBuilderList() {
      return edges_;
    }
    ...
    public shortestPath.HypergraphProto.HyperedgeOrBuilder getEdgesOrBuilder(
        int index) {
      return edges_.get(index);
    }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements shortestPath.HypergraphProto.HypergraphOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return shortestPath.HypergraphProto.internal_static_shortestPath_Hypergraph_descriptor;
      }
      ...
      public shortestPath.HypergraphProto.Hypergraph build() {
        shortestPath.HypergraphProto.Hypergraph result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public shortestPath.HypergraphProto.Hypergraph buildPartial() {
        shortestPath.HypergraphProto.Hypergraph result = new shortestPath.HypergraphProto.Hypergraph(this);
        int from_bitField0_ = bitField0_;
        if (verticesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) == 0x00000001)) {
      ...
      private void ensureVerticesIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          vertices_ = new java.util.ArrayList<shortestPath.HypergraphProto.Vertex>(vertices_);
          bitField0_ |= 0x00000001;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          shortestPath.HypergraphProto.Vertex, shortestPath.HypergraphProto.Vertex.Builder, shortestPath.HypergraphProto.VertexOrBuilder> verticesBuilder_;
      ...
      public Builder setVertices(
          int index, shortestPath.HypergraphProto.Vertex value) {
        if (verticesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setVertices(
          int index, shortestPath.HypergraphProto.Vertex.Builder builderForValue) {
        if (verticesBuilder_ == null) {
          ensureVerticesIsMutable();
      ...
      public Builder addVertices(
          shortestPath.HypergraphProto.Vertex.Builder builderForValue) {
        if (verticesBuilder_ == null) {
          ensureVerticesIsMutable();
      ...
      public shortestPath.HypergraphProto.Vertex.Builder getVerticesBuilder(
          int index) {
      ...
      public shortestPath.HypergraphProto.Vertex.Builder addVerticesBuilder() {
        return getVerticesFieldBuilder().addBuilder(
            shortestPath.HypergraphProto.Vertex.getDefaultInstance());
      }
      public shortestPath.HypergraphProto.Vertex.Builder addVerticesBuilder(
          int index) {
        return getVerticesFieldBuilder().addBuilder(
            index, shortestPath.HypergraphProto.Vertex.getDefaultInstance());
      }
      public java.util.List<shortestPath.HypergraphProto.Vertex.Builder> 
           getVerticesBuilderList() {
        return getVerticesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          shortestPath.HypergraphProto.Vertex, shortestPath.HypergraphProto.Vertex.Builder, shortestPath.HypergraphProto.VertexOrBuilder> 
          getVerticesFieldBuilder() {
        if (verticesBuilder_ == null) {
      ...
      private void ensureEdgesIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          edges_ = new java.util.ArrayList<shortestPath.HypergraphProto.Hyperedge>(edges_);
          bitField0_ |= 0x00000002;
         }
      }
      
      private com.google.protobuf.RepeatedFieldBuilder<
          shortestPath.HypergraphProto.Hyperedge, shortestPath.HypergraphProto.Hyperedge.Builder, shortestPath.HypergraphProto.HyperedgeOrBuilder> edgesBuilder_;
      ...
      public Builder setEdges(
          int index, shortestPath.HypergraphProto.Hyperedge value) {
        if (edgesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setEdges(
          int index, shortestPath.HypergraphProto.Hyperedge.Builder builderForValue) {
        if (edgesBuilder_ == null) {
          ensureEdgesIsMutable();
      ...
      public Builder addEdges(
          shortestPath.HypergraphProto.Hyperedge.Builder builderForValue) {
        if (edgesBuilder_ == null) {
          ensureEdgesIsMutable();
      ...
      public shortestPath.HypergraphProto.Hyperedge.Builder getEdgesBuilder(
          int index) {
      ...
      public shortestPath.HypergraphProto.Hyperedge.Builder addEdgesBuilder() {
        return getEdgesFieldBuilder().addBuilder(
            shortestPath.HypergraphProto.Hyperedge.getDefaultInstance());
      }
      public shortestPath.HypergraphProto.Hyperedge.Builder addEdgesBuilder(
          int index) {
        return getEdgesFieldBuilder().addBuilder(
            index, shortestPath.HypergraphProto.Hyperedge.getDefaultInstance());
      }
      public java.util.List<shortestPath.HypergraphProto.Hyperedge.Builder> 
           getEdgesBuilderList() {
        return getEdgesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilder<
          shortestPath.HypergraphProto.Hyperedge, shortestPath.HypergraphProto.Hyperedge.Builder, shortestPath.HypergraphProto.HyperedgeOrBuilder> 
          getEdgesFieldBuilder() {
        if (edgesBuilder_ == null) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\035basicViterbi/hypergraph.proto\022\014shortes" +
      "tPath\"C\n\006Vertex\022\n\n\002id\030\001 \002(\005\022\014\n\004name\030\002 \002(" +
      "\t\022\016\n\006inEdge\030\003 \003(\005\022\017\n\007outEdge\030\004 \003(\005\"N\n\tHy" +
      "peredge\022\n\n\002id\030\001 \002(\005\022\016\n\006weight\030\002 \002(\001\022\023\n\013c" +
      "hildrenIds\030\003 \003(\005\022\020\n\010parentId\030\004 \001(\005\"\\\n\nHy" +
      "pergraph\022&\n\010vertices\030\001 \003(\0132\024.shortestPat" +
      "h.Vertex\022&\n\005edges\030\002 \003(\0132\027.shortestPath.H" +
      "yperedgeB\021B\017HypergraphProto"
    };
